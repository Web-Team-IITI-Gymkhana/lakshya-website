...
import image from "./img/Group 40.png";
      ...
      <div className="w-[80%] mx-auto my-24">
        ...
        <div>
          <div className="flex items-center justify-center my-3 flex-col lg:flex-row justify-between">
            <div className=" w-[100%] sm:mb-8 lg:w-[60%]  lg:mr-4 text-lg sm:text-xl ">
              <div className="mb-6 ">
                Encouraging participants to engage in physical activity and
                adopt a healthy lifestyle is often a primary goal. Sports fests
                provide a platform for individuals to showcase their athletic
                abilities and motivate others to participate in regular physical
                exercise.
                </div>
              <div className="mb-6 ">
                Many sports fests involve team-based competitions, fostering a
                spirit of teamwork and collaboration. Participants learn the
                importance of working together towards a common goal, enhancing
