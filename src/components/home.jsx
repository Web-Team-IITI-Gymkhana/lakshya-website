    ...
    return (
        <div className='mt-[48px]' >
            ...
            <div className=' absolute top-0 w-[100%] flex flex-col place-content-center items-center h-[270px] sm:h-[400px] md:h-[470px] lg:h-[800px]'>
                ...
                <div className='font-medium text-[15px] sm:text-[17px] sm:mt-[-40px] md:text-[24px] md:mt-[-60px] lg:text-[28px] lg:mt-[-90px] xl:text-[30px] xl:mt-[-100px] text-[#adadad]  mt-[-30px] text-white'>Never give up</div>
                <div className='font-medium text-[15px] text-[#adadad] mt-[-9px] sm:mt-[-5px] md:text-[24px] lg:text-[28px] xl:text-[30px] text-white'>Momentum is life</div>
            </div>
